                        ...
                        <div class="shadow-sm h-100 bg-white rounded-3 p-3 mt-4">
                                        ...
                                        <tbody>
                                            <tr :v-if="selectedProduct.length > 0"
                                                ...
                                                <td>
                                                    ...
                                                    <button class="me-2" @click="addQty(product.id)">+</button>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <hr class="mx-0 my-2 p-0 bg-secondary"/>
                                    <p class="text-bold text-xs my-1 text-dark">Payable:{{ payable }} <i class="bi bi-currency-dollar"></i> </p>
...
//==========Start Billed to===========
        ...
        //---removeQty button End----

        //----removeProductFromSale button Start----
        const removeProductFromSale = (index) =>{
            selectedProduct.value.splice(index,1);
            calculateTotal(); 
        }

        //----removeProductFromSale button End-----
