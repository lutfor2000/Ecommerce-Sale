                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <p class="mb-1">Name: <span>{{customerData.customer.name }} </span></p>
                            <p class="mb-1">Email: <span>{{ customerData.customer.email }}  </span></p>
                            <p class="mb-1">Customer ID: <span>{{ customerData.customer.id }} </span></p>
                            <p class="mb-1">Phone: <span> {{ customerData.customer.mobile }} </span></p>
                        </div>
                        ...
                        <div class="col-4 text-right">
                            ...
                            <p class="mb-1">Time: {{ new Date().toLocaleTimeString() }} </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr  v-for="(item, index) in customerData.invoice_product" :key="index">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p><strong>Total:</strong> {{ customerData.total }}</p>
                            <p><strong>Payable:</strong> {{customerData.payable}}</p>
                            <p><strong>VAT (5%):</strong> {{ customerData.vat }}</p>
                            <p><strong>Discount:</strong> {{ customerData.discount }}</p>
                        </div>
                    </div>
                </div>
            </div>
